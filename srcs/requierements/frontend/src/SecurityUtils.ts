...
export class SecurityUtils {
    ...
    private static readonly USERNAME_REGEX = /^[a-zA-Z0-9]{3,10}$/;
    private static readonly EMAIL_LOCAL_REGEX = /^[a-zA-Z0-9]([a-zA-Z0-9.-]*[a-zA-Z0-9])?$/;
    private static readonly EMAIL_DOMAIN_REGEX = /^[a-zA-Z0-9]([a-zA-Z0-9-]*[a-zA-Z0-9])?$/;
    private static readonly EMAIL_EXTENSION_REGEX = /^[a-zA-Z]{2,6}$/;
	...
	validateUsername(username: string): number {
	...
	validateEmail(mail: string): number {
