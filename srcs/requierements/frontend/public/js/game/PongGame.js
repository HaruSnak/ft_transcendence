...
export class PongGame {
    constructor(buttonStart, buttonPause, buttonReset, divMessageWinOrLose, divInterfaceInGame, divInterfaceMainMenu) {
        this.buttonStart = buttonStart;
        this.buttonPause = buttonPause;
        this.buttonReset = buttonReset;
        this.divMessageWinOrLose = divMessageWinOrLose;
        this.divInterfaceInGame = divInterfaceInGame;
        this.divInterfaceMainMenu = divInterfaceMainMenu;
