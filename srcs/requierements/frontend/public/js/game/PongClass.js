...
export class PongGame {
    constructor() {
        ...
        this.WINNING_SCORE = 30; // Score pour gagner la partie
        // Stocker les touches
        this.keys = new Set();
        // Canvas et contexte/bouttons
        this.canvas = document.getElementById('pongCanvas');
        this.ctx = this.canvas.getContext('2d');
        this.buttonStart = document.getElementById('startGameButton');
        this.buttonPause = document.getElementById('pauseGameButton');
        this.buttonReset = document.getElementById('resetGameButton');
        this.buttonPractice = document.getElementById('practiceGameButton');
        this.buttonPlyLocal = document.getElementById('plyLocalGameButton');
        this.buttonTournament = document.getElementById('tournamentGameButton');
        ...
        this.TARGET_POSITION_OFFSET = this.PADDLE_HEIGHT / 2; // Décalage pour centrer la position cible du bot
    ...
    // ==================== START and PAUSE ====================
    updateScreen() {
        this.buttonPractice.style.display = 'none';
        this.buttonPlyLocal.style.display = 'none';
        this.buttonTournament.style.display = 'none';
