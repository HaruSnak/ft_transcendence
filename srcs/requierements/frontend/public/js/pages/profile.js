...
function showMessage(message, isError = true) {
    ...
    messageDiv.className = `profile-message p-3 mb-4 rounded text-center ${isError ? 'bg-red-600 text-white' : 'bg-green-600 text-white'}`;
...
async function deleteAccount() {
    const confirmDelete = confirm('⚠️ ATTENTION ⚠️\n\n' +
...
// element du profil
function renderProfile(container, user, isDemo) {
    container.innerHTML = `
