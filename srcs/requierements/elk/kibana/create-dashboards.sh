...
# Create Dashboard
echo ""
echo "6. Creating main dashboard..."
curl -s -X POST "${KIBANA_URL}/api/saved_objects/dashboard/main-dashboard?overwrite=true" \
  ...
  -d '{
    "attributes": {
      "title": "ft_transcendence Logging Overview",
      "hits": 0,
...
echo ""
echo "7. Creating security dashboard..."
curl -s -X POST "${KIBANA_URL}/api/saved_objects/dashboard/security-dashboard?overwrite=true" \
  -u "elastic:${ELASTIC_PASSWORD}" \
  -H "kbn-xsrf: true" \
  -H "Content-Type: application/json" \
  -d '{
    "attributes": {
      ...
      "hits": 0,
      "description": "Security events, failed logins, and system monitoring",
      "panelsJSON": "[{\"version\":\"7.17.25\",\"gridData\":{\"x\":0,\"y\":0,\"w\":48,\"h\":15,\"i\":\"1\"},\"panelIndex\":\"1\",\"embeddableConfig\":{},\"panelRefName\":\"panel_0\"},{\"version\":\"7.17.25\",\"gridData\":{\"x\":0,\"y\":15,\"w\":24,\"h\":12,\"i\":\"2\"},\"panelIndex\":\"2\",\"embeddableConfig\":{},\"panelRefName\":\"panel_1\"},{\"version\":\"7.17.25\",\"gridData\":{\"x\":24,\"y\":15,\"w\":24,\"h\":12,\"i\":\"3\"},\"panelIndex\":\"3\",\"embeddableConfig\":{},\"panelRefName\":\"panel_2\"}]",
      "optionsJSON": "{\"hidePanelTitles\":false,\"useMargins\":true}",
      "version": 1,
      "timeRestore": false,
      "kibanaSavedObjectMeta": {
    ...
    "references": [
      {"name": "panel_0", "type": "visualization", "id": "security-events"},
      {"name": "panel_1", "type": "visualization", "id": "log-levels"},
      {"name": "panel_2", "type": "visualization", "id": "events-by-type"}
    ]
  }' > /dev/null
